...
80 MCQ / 60 min) and Paper 3 (Test of Orals, 60 MCQ / 45 min)**, and **Mathematics:
Paper 1 (Objective, 50 MCQ / 90 min)** — with WAEC grade guidance (A1–F9) on the result.
A subject appears on the WAEC page only once its bank has ≥10 questions, so Biology,
Chemistry, Physics, Economics and Government will appear as their batches are added
(same `content/batch_*.json` mechanism as JAMB). Results carry a pace meter and the
same review/PDF flow as JAMB.
