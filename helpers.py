...
COURSE_GROUPS = [
    ...
    ("Agriculture", [
        ...
        ("Agricultural Science (B.Agric)", [E, CHM, AGR, MTH]),
        ("Agricultural Economics and Extension", [E, CHM, AGR, MTH]),
        ("Animal Science", [E, CHM, AGR, MTH]),
        ("Crop Science", [E, CHM, AGR, MTH]),
        ("Soil Science", [E, CHM, AGR, MTH]),
        ("Forestry and Wildlife Management", [E, CHM, AGR, MTH]),
        ("Fisheries and Aquaculture", [E, CHM, AGR, MTH]),
    ]),
...
COURSE_ICONS = {
    ...
    "Agricultural Science (B.Agric)": ("bi-flower1", "tint-green"),
    "Agricultural Economics and Extension": ("bi-basket", "tint-gold"),
    "Animal Science": ("bi-piggy-bank", "tint-green"),
    "Crop Science": ("bi-flower2", "tint-green"),
    "Soil Science": ("bi-layers", "tint-gold"),
    "Forestry and Wildlife Management": ("bi-tree-fill", "tint-green"),
    "Fisheries and Aquaculture": ("bi-water", "tint-cyan"),
